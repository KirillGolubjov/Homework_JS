...
// get3Countries('Estonia', 'Russia', 'Spain');
...
//     getJSON(`https://restcountries.com/v2/name/brasil`),
//   ]);
//   console.log(res[0]);
// })();
...
// // //Promise.any[ES2021]; Rejected Promises are ignored
// Promise.any([
//   Promise.resolve('Success'),
//   Promise.reject('ERROR'),
//   Promise.resolve('ANother success'),
